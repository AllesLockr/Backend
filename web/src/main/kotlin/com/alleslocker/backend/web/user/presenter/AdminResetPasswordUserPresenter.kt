...
internal class AdminResetPasswordUserPresenter(
    httpServletResponse: HttpServletResponse,
    jacksonConverter: MappingJackson2HttpMessageConverter,
) : JsonRestPresenter<AdminResetPasswordUserResponseDto>(httpServletResponse, jacksonConverter) {
    override fun present(response: AdminResetPasswordUserResponseDto) {
