...
internal class GetVendorSpecificDefinitionsPresenter(
    httpServletResponse: HttpServletResponse,
    jacksonConverter: MappingJackson2HttpMessageConverter,
) : JsonRestPresenter<GetVendorSpecificDefinitionsResponseDto>(httpServletResponse, jacksonConverter) {
    override fun present(response: GetVendorSpecificDefinitionsResponseDto) {
