        ...
        val saved =
            try {
                ...
                presenter.presentFailure(
                    ErrorResponse.InternalServerError("Failed to save person: ${e.message ?: "Unknown error"}"),
                )
                return
            }
        val adapterResponse =
            try {
                ...
                presenter.presentFailure(
                    ErrorResponse.InternalServerError("Failed to send to API: ${e.message ?: "Unknown error"}"),
                )
                return
            }
        val apiIdentities =
